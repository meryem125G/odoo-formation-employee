# -*- coding: utf-8 -*-
{
    ...
    'description': "<ul><li>Planification des sessions de formation</li><li>Suivi administratif des participants</li><li>Suivi des compétences et indicateurs (KPI)</li><li>Gestion des formateurs et organismes</li><li>Organisation par thèmes et modules</li><li>Analyse et reporting</li></ul><p>Vidéo de démonstration (commentée pour l'instant)</p>",
